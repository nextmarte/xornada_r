...
Capital asset pricing model(CAPM)[@sharpe1964], $\beta$, witch, measures the portfolio risk sensibility to a specified non-diversifiable risk asset , here the IFIX was used as reference.$$\beta=\frac{Cov(P;IFIX)}{\sigma_{IFIX}^2}$$
