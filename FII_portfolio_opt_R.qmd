...
The chosen assets price data was downloaded within time window of 2017 to 2019 with the package quantmod[@ryanQuantmodQuantitativeFinancial2022] and Yahoo Finance[@yahoofi] as source. After the price data vesting, followed the monthly returns calculation using dplyr[@wickham2022]
